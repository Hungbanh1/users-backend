                    ...
                    <div class="section-detail clearfix">
                        <div class="thumb-wp fl-left">
                            <a href="" title="" id="main-thumb">
                                <img id="zoom" src="{{ asset(asset($zoom_products->t3501)) }}"
                                    data-zoom-image="{{ asset(asset($zoom_products->thumb1)) }}" />
                            </a>
                            <div id="list-thumb">
                                <a href="" data-image="{{ asset(asset($zoom_products->t3501)) }}"
                                    data-zoom-image="{{ asset(asset($zoom_products->thumb1)) }}">
                                    <img id="zoom" src="{{ asset(asset($zoom_products->t501)) }}" />
                                </a>
                                <a href="" data-image="{{ asset(asset($zoom_products->t3502)) }}"
                                    data-zoom-image="{{ asset(asset($zoom_products->thumb2)) }}">
                                    <img id="zoom" src="{{ asset(asset($zoom_products->t502)) }}" />
                                </a>
                                <a href="" data-image="{{ asset(asset($zoom_products->t3503)) }}"
                                    data-zoom-image="{{ asset(asset($zoom_products->thumb3)) }}">
                                    <img id="zoom" src="{{ asset(asset($zoom_products->t503)) }}" />
                                </a>
                                <a href="" data-image="{{ asset(asset($zoom_products->t3504)) }}"
                                    data-zoom-image="{{ asset(asset($zoom_products->thumb4)) }}">
                                    <img id="zoom" src="{{ asset(asset($zoom_products->t504)) }}" />
                                </a>
                                <a href="" data-image="{{ asset(asset($zoom_products->t3505)) }}"
                                    data-zoom-image="{{ asset(asset($zoom_products->thumb5)) }}">
                                    <img id="zoom" src="{{ asset(asset($zoom_products->t505)) }}" />
                                </a>
                                <a href="" data-image="{{ asset(asset($zoom_products->t3501)) }}"
                                    data-zoom-image="{{ asset(asset($zoom_products->thumb1)) }}">
                                    <img id="zoom" src="{{ asset(asset($zoom_products->t501)) }}" />
                        ...
                        <div class="thumb-respon-wp fl-left">
                            <img src="{{asset(img-pro-01.png)}}" alt="">
                        </div>
